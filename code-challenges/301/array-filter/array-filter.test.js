...
const filterStringsWithVowels = (arr) => {
  var vowelReg = /[aeiou]+/;
  return arr.filter((value,i) => {
      return vowelReg.test(value);
  });
};

// console.log(filterStringsWithVowels(['gregor','hound','xyz', 'abc', '*****d']));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const notInFirstArray = (forbiddenValues, arr) => {
  return arr.filter((value,i) => {
      return (forbiddenValues.indexOf(value) < 0);
  });
};
...
const getStatName = (arr, minBaseStat) => {
  return getBaseStatGreaterThan(arr,minBaseStat).map((value,i) => {
...
const evenOddNumericValues = (arr) => {
  var numArr = arr.filter((value,i) => {
      return (typeof value) === 'number';
  });
  return numArr.map((value,i) => {
      return (value % 2 === 0)? 'even' : 'odd';
  });
};

// console.log(evenOddNumericValues(['1', 2, 3, 'hi']));
