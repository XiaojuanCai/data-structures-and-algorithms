...
// console.log(matchMonth('october'));
// console.log(matchMonth('octob'));
// console.log(matchMonth('OCTOBER'));
// console.log(matchMonth('November'));
...
// console.log(noPunctuation("Hello, and have a wonderful day!"));
...
// console.log(hangman("Welcome to Code 301"));
